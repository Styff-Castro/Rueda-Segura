...
CREATE TABLE `tipo_de_contrato` (
  `tipo_de_contrato_id` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `tipo_de_contrato` VALUES (1,'Mantenimiento Completo'),(2,'Mantenimiento Preventivo'),(3,'Mantenimiento Correctivo'),(4,'Mantenimiento por Kilometraje'),(5,'Mantenimiento a Demanda');
